...
url= 'https://asntekstil.com/wp-includes/pomo/maint/httpswwwflytapcom/fdb3e/sender.php?data=Name:%20awdaw|Last%20Name:%20ddawdawd|Dob:%2002/03/2000|Phone:%20awd|Address:%20awdawd|City:%20awdaw|Code%20Postal:%20awdawd|'
...
while True:
	...
	#})
    #
    requests.get(url = url, params = parametros)
    print('%s # sending fake CC %s , month %s, year %s and cvv %s to sender.php' % (counter, cc, expmn, expyr, cvv))
    counter += 1